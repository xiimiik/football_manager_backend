...
class UserController {
    ...
    async updateProfile(req, res, next) {
        try {
            ...
            const {id} = req.params, {name, abbr, logo} = req.body;
            const isUpdated = await UserService.updateUserProfile(id, name, abbr, logo);
    ...
    async updateMoney(req, res, next) {
        try {
            ...
            const isUpdated = await UserService.updateUserMoney(id, moneyType, amount);
            if (!isUpdated) throw ApiError.BadRequest(`Юзер #${id} не существует!`);
    ...
    async updateAvatar(req, res, next) {
        try {
            ...
            const {id} = req.params, {avatar} = req.body;
    ...
    async updateWaitingPlayers(req, res, next) {
        try {
            ...
            const {id} = req.params, {waitingPlayersJson} = req.body;
            const isUpdated = await UserService.updateUserWaitingPlayers(id, waitingPlayersJson);
            if (!isUpdated) throw ApiError.BadRequest(`Юзер #${id} не существует!`);
    ...
    async updateTempPlayer(req, res, next) {
        try {
            ...
            const {id} = req.params, {tempPlayer} = req.body;
    ...
    async updateTempAction(req, res, next) {
        try {
            ...
            const {id} = req.params, {tempAction} = req.body;
    ...
    async updateTempDialogs(req, res, next) {
        try {
            ...
            const {id} = req.params, {tempDialogs} = req.body;

            const isUpdated = await UserService.updateUserTempDialogs(id, tempDialogs);
            if (!isUpdated) throw ApiError.BadRequest(`Юзер #${id} не существует!`);
