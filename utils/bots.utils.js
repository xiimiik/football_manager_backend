...
const
    ...
    botsIcons = ["bee", "cherry", "city", "cottager", "devil", "eagle", "forest", "fox", "gun", "hammer", "magpie", "pen", "reds", "seagull", "toffee", "villian"],
    botsColors = ["#090E19FF", "#135AE0FF", "#A01843FF", "#A5FF5BFF", "#EC242DFF", "#90CAFFFF", "#FAFCFFFF", "#FFDA25FF"];


function createLastTeam(cards) {
    ...
    for (const card of cards) preferedCardPositions[card.preferedPosition].push(card);
